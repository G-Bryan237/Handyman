  ...
  const providers = [
    {
      ...
      description: "Professional deep cleaning services for homes and apartments with eco-friendly cleaning products and trained staff.",
      transactions: {
        total: 312,
        last30Days: 42,
        successRate: 99.5
      ...
      onlineStatus: "online",
      type: "company",
      teamSize: "12 cleaners"
    },
    {
      id: '2',
      name: "SparkleHome",
      specialty: "Regular Cleaning",
      description: "Regular home cleaning services on daily, weekly, or monthly schedules. Reliable and thorough cleaning every time.",
      transactions: {
        total: 175,
        last30Days: 26,
        successRate: 97.8
    ...
    {
      id: '3',
      name: "Office Cleaners Pro",
      specialty: "Commercial Cleaning",
      description: "Specialized in commercial and office space cleaning with flexible hours, including after business hours service.",
      transactions: {
        total: 128,
        last30Days: 18,
        successRate: 98.2
    ...
    },
    {
      ...
      description: "Environmentally friendly cleaning services using only natural products that are safe for children, pets, and the planet.",
      transactions: {
        total: 87,
        last30Days: 14,
        successRate: 99.0
