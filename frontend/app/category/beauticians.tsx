...
const BeauticiansPage = () => {
  ...
  // Provider data for this category with transactions
  const providers = [
    {
      id: '1',
      name: "Beauty Plus",
      specialty: "Hair Styling & Makeup",
      description: "Professional hair styling and makeup services for all occasions. Our team of stylists brings the latest trends to you.",
      transactions: {
        total: 245,
        last30Days: 36,
        successRate: 99.2
    ...
    },
    {
      ...
      description: "Specialized nail services including manicures, pedicures, gel, and creative nail art designs with top quality products.",
      transactions: {
        total: 167,
        last30Days: 22,
        successRate: 98.1
      ...
      type: "company",
      teamSize: "5 nail technicians"
    },
    {
      id: '3',
      name: "Beauty Hub",
      specialty: "Full Beauty Services",
      description: "Complete beauty solutions under one roof. From hair styling to skincare, we have all your beauty needs covered.",
      transactions: {
        total: 203,
        last30Days: 28,
        successRate: 97.5
      ...
      onlineStatus: "online",
      type: "company",
      teamSize: "10 beauty experts"
    },
    {
      id: '4',
      name: "Sophia's Beauty",
      specialty: "Skincare Treatments",
      description: "Expert skincare treatments tailored to your skin's needs. Facials, peels, and personalized skincare regimens.",
      transactions: {
        total: 89,
        last30Days: 17,
        successRate: 96.8
