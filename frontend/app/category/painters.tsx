...
const PaintersPage = () => {
  ...
  // Provider data for painters category
  const providers = [
    {
      id: '1',
      name: "Premium Painters",
      specialty: "Interior & Exterior Painting",
      description: "Professional painting services for both interior and exterior surfaces. We deliver exceptional quality and attention to detail.",
      transactions: {
        total: 178,
        last30Days: 23,
        successRate: 99.1
    ...
    },
    {
      ...
      description: "Specialized in decorative painting techniques like faux finishes, murals, and custom designs for unique interiors.",
      transactions: {
        total: 132,
        last30Days: 18,
        successRate: 98.4
    ...
    },
    {
      id: '3',
      name: "James Painter",
      specialty: "Residential Painting",
      description: "Reliable and efficient residential painting services with careful preparation and quality materials for lasting results.",
      transactions: {
        total: 84,
        last30Days: 12,
        successRate: 97.6
    ...
    {
      id: '4',
      name: "Commercial Painting Pro",
      specialty: "Commercial Painting",
      description: "Specialized in large-scale commercial painting projects with minimal disruption to business operations.",
      transactions: {
        total: 212,
        last30Days: 15,
        successRate: 98.9
    ...
    <View className="flex-1 bg-gray-50">
      ...
      <View className="bg-primary-500 pt-12 pb-4 px-5">
        <View className="flex-row items-center mb-3">
          ...
          <Text className="text-white text-xl font-bold">Painters</Text>
        </View>
      ...
      >
        ...
        <View className="px-4 mb-4">
          <View className="flex-row items-center mb-2">
            ...
            <Text className="text-gray-800 text-lg font-semibold">Find painters near you</Text>
          </View>
