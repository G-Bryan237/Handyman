...
const SmartHomePage = () => {
  ...
  // Provider data for smart home
  const providers = [
    {
      id: '1',
      name: "Smart Living Solutions",
      specialty: "Full Home Automation",
      description: "Complete smart home installation including lighting, security, HVAC, and voice control integration for modern homes.",
      transactions: {
        total: 234,
        last30Days: 28,
        successRate: 99.3
    ...
    },
    {
      ...
      description: "Smart security systems with cameras, sensors, and remote monitoring to keep your home safe and secure.",
      transactions: {
        total: 156,
        last30Days: 19,
        successRate: 98.7
    ...
    },
    {
      id: '3',
      name: "Tech Masters",
      specialty: "Entertainment Systems",
      description: "Smart entertainment system installation with multi-room audio, home theater, and streaming device integration.",
      transactions: {
        total: 187,
        last30Days: 24,
        successRate: 98.4
    ...
    },
    {
      ...
      description: "Smart lighting solutions for energy efficiency, security, and creating the perfect ambiance in any room.",
      transactions: {
        total: 92,
        last30Days: 12,
        successRate: 97.8
    ...
    <View className="flex-1 bg-gray-50">
      ...
      <View className="bg-primary-500 pt-12 pb-4 px-5">
        <View className="flex-row items-center mb-3">
          ...
          <Text className="text-white text-xl font-bold">Smart Home</Text>
        </View>
      ...
      >
        ...
        {/* <View className="px-4 mb-4">
          <View className="flex-row items-center mb-2">
            <View className="bg-[#3b82f6] rounded-full p-2 mr-2">
              <MaterialIcons name="home" size={20} color="white" />
            </View>
            <Text className="text-gray-800 text-lg font-semibold">Find smart home experts near you</Text>
          </View>
          <Text className="text-gray-600 text-sm">
            Professional installation and setup of smart home devices, automation systems, and security solutions
          </Text>
        </View> */}
