...
const MechanicsPage = () => {
  ...
  // Provider data for mechanics
  const providers = [
    {
      id: '1',
      name: "AutoCare Professionals",
      specialty: "General Auto Repair",
      description: "Complete auto repair and maintenance services including engine, transmission, brakes and electrical system diagnostics.",
      transactions: {
        total: 267,
        last30Days: 32,
        successRate: 99.2
    ...
    },
    {
      ...
      specialty: "On-site Repairs",
      description: "Mobile mechanic services that come to your location for repairs, diagnostics, and routine maintenance.",
      transactions: {
        total: 186,
        last30Days: 26,
        successRate: 98.5
    ...
    },
    {
      ...
      description: "Specializing in European luxury and performance vehicles with factory-trained experience and diagnostic tools.",
      transactions: {
        total: 95,
        last30Days: 14,
        successRate: 97.8
    ...
    },
    {
      ...
      description: "24/7 emergency auto repair and roadside assistance for breakdowns, jump starts, tire changes and more.",
      transactions: {
        total: 231,
        last30Days: 38,
        successRate: 98.7
    ...
    <View className="flex-1 bg-gray-50">
      ...
      <View className="bg-primary-500 pt-12 pb-4 px-5">
        <View className="flex-row items-center mb-3">
          ...
          <Text className="text-white text-xl font-bold">Mechanics</Text>
        </View>
      ...
      >
        ...
        <View className="px-4 mb-4">
          <View className="flex-row items-center mb-2">
            ...
            <Text className="text-gray-800 text-lg font-semibold">Find mechanics near you</Text>
          </View>
