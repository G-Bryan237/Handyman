...
const MoversPage = () => {
  ...
  // Provider data for movers
  const providers = [
    {
      id: '1',
      name: "Premier Moving Co.",
      specialty: "Residential Moves",
      description: "Full-service residential moving company with professional packing, transportation, and unpacking services.",
      transactions: {
        total: 239,
        last30Days: 35,
        successRate: 99.1
      ...
      reviews: 267,
      startingPrice: 35000,
      imageUrl: require('../../assets/images/movers/mov1.jpg'),
      onlineStatus: "online",
      type: "company",
      teamSize: "15 movers"
    },
    {
      id: '2',
      name: "Office Relocators",
      specialty: "Commercial Moving",
      description: "Specialized in office and business relocations with minimal downtime and careful handling of equipment.",
      transactions: {
        total: 178,
        last30Days: 24,
        successRate: 98.7
      ...
      reviews: 203,
      startingPrice: 50000,
      imageUrl: require('../../assets/images/movers/mov2.jpg'),
      onlineStatus: "online",
      type: "company",
    ...
    },
    {
      id: '3',
      name: "Quick Movers",
      specialty: "Small Moves & Deliveries",
      description: "Fast and efficient moving services for small apartments, single items, and time-sensitive deliveries.",
      transactions: {
        total: 126,
        last30Days: 22,
        successRate: 97.5
      ...
      reviews: 168,
      startingPrice: 20000,
      imageUrl: require('../../assets/images/movers/mov3.jpg'),
      onlineStatus: "online",
      type: "company",
      teamSize: "8 movers"
    },
    {
      id: '4',
      name: "Michael's Moving Service",
      specialty: "Furniture Moving",
      description: "Specialized in careful handling and transportation of furniture including assembly and disassembly services.",
      transactions: {
        total: 87,
        last30Days: 16,
        successRate: 96.8
      ...
      reviews: 112,
      startingPrice: 15000,
      imageUrl: require('../../assets/images/movers/mov4.jpg'),
    ...
    <View className="flex-1 bg-gray-50">
      ...
      <View className="bg-primary-500 pt-12 pb-4 px-5">
        <View className="flex-row items-center mb-3">
          ...
          <Text className="text-white text-xl font-bold">Movers</Text>
        </View>
      ...
      >
        ...
        {/* <View className="px-4 mb-4">
          <View className="flex-row items-center mb-2">
            <View className="bg-[#8b5cf6] rounded-full p-2 mr-2">
              <FontAwesome5 name="truck-moving" size={20} color="white" />
            </View>
            <Text className="text-gray-800 text-lg font-semibold">Find movers near you</Text>
          </View>
          <Text className="text-gray-600 text-sm">
            Professional moving services for homes, offices, and single-item transportation
          </Text>
        </View> */}
